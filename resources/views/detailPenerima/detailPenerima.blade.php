                                      ...
                                      <div class="col-md-12 text-center">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                              ...
                                              <div class="form-group col">
                                                  ...
                                                  <input class="form-control" type="text" name="nama_penerima" value="{{ $data_user->nama_penerima }}" readonly>
                                              </div>

                                              <div class="form-group col">
                                                  <label>Alamat Rumah</label>
                                                  <textarea class="form-control" name="alamat" style="height: 125px" readonly>{{ $data_user->alamat }}</textarea>
                                              </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    <input class="form-control" type="text" name="tanggal_lahir" value="{{ $data_user->tanggal_lahir }}" readonly>
                                                </div>

                                                <div class="form-group col">
                                                    <label>Tempat Lahir</label>
                                                    <input class="form-control" type="text" name="tempat_lahir" value="{{ $data_user->tempat_lahir }}" readonly>
                                                </div>

                                                <div class="form-group col">
                                                    <label>Hubungan</label>
                                                    <input class="form-control" type="text" name="hubungan" value="{{ $data_user->hubungan }}" readonly>
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    <br>
                                                    <select class="form-control" name="jenis_kelamin" id="user_id_select" @readonly(true)>
                                                ...
                                                <div class="form-group col">
                                                    <label>NIK</label>
                                                    <input class="form-control" type="text" name="nik" value="{{ $data_user->nik }}" readonly>
                                                </div>

                                                <div class="form-group col">
                                                    <label>No KTP</label>
                                                    <input class="form-control" type="text" name="no_ktp" value="{{ $data_user->no_ktp }}" readonly>
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    <label>Telepon</label>
                                                    <input class="form-control" type="text" name="no_telp" value="{{ $data_user->no_telp }}" readonly>
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                              ...
                                              <div class="form-group col">
                                                  ...
                                                  <input class="form-control" type="text" name="umur" value="{{ $data_user->umur }}" readonly>
                                              </div>
                                          ...
                                          <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    <label>Email</label>
                                                    <input class="form-control" type="text" name="email" value="{{ $data_user->email }}" readonly>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    <br>
                                                    <select class="form-control" name="jenis_asuransi" id="user_id_select" @readonly(true)>
                                                        @if ($data_user->jenis_asuransi=="Asuransi Jiwa")
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    <br>
                                                    <select class="form-control" name="periode_pembayaran" id="user_id_select" @readonly(true)>
                                                        @if ($data_user->periode_pembayaran=="bulan")
                                                        <option   value="bulan">Bulan</option>
                                                        @elseif ($data_user->periode_pembayaran=="taun")
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group col">
                                                    ...
                                                    <br>
                                                    <select class="form-control" name="jumlah_tanggungan" id="user_id_select" @readonly(true)>
                                                        @if ($data_user->jumlah_tanggungan==100000)

                                                        <option   value="100000">Rp. 100.000,-</option>
                                                        @elseif ($data_user->jumlah_tanggungan==250000)

                                                        <option value="250000">Rp. 250.000,-</option>
                                                        @elseif ($data_user->jumlah_tanggungan==500000)

                                                        <option value="500000">Rp. 500.000,-</option>
                                                        @elseif($data_user->jumlah_tanggungan==750000)
